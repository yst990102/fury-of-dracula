...
int main(void)
{
	...
	{///////////////////////////////////////////////////////////////////
		...
		char *trail =
			"GGE.... SGE.... HVI.... MGE.... DKL.V.. "
			
			"GGE.... SGE.... HBD.... MGE.... DGAT... "
			"GGE.... SGE.... HSZ.... MGE.... DC?T... "
			"GGE.... SGE.... HKLT... MGE.... DC?T... "
			"GGE.... SGE.... HCDV... MGE.... DD1T...";
		...
		Round round = -1;
		printf("%d\n",HvGetLastKnownDraculaLocation(hv, &round));
		assert(HvGetLastKnownDraculaLocation(hv, &round) == GALATZ);
		assert(round == 1);
	...
	{///////////////////////////////////////////////////////////////////
		...
		printf("Checking Paris  connections "
		       "(Lord Godalming, Round 1)\n");
		...
		int numLocs = -1;
		PlaceId *locs = HvWhereCanTheyGo(hv, PLAYER_LORD_GODALMING,
		                                        &numLocs);
		...
		assert(locs[4] == LE_HAVRE);
		assert(locs[5] == MARSEILLES);
		assert(locs[6] == NANTES);
		assert(locs[7] == PARIS);
		assert(locs[8] == STRASBOURG);
		free(locs);
    ...
    {///////////////////////////////////////////////////////////////////
		...
		int numLocs = -1;
		PlaceId *locs = HvWhereCanTheyGo(hv, PLAYER_DR_SEWARD,
		                                        &numLocs);
	...
	{///////////////////////////////////////////////////////////////////
		...
		int numLocs = -1;
		PlaceId *locs = HvWhereCanTheyGo(hv, PLAYER_VAN_HELSING,
		                                        &numLocs);
	...
	{///////////////////////////////////////////////////////////////////
		...
		printf("Checking SEGED  connections "
		       "(DRACULA, Round 1)\n");
		
		char *trail = "GPA.... SPA.... HPA.... MPA.... DSZ.V..";
		Message messages[5] = {};
		HunterView hv = HvNew(trail, messages);
		
		int numLocs = -1;
		PlaceId *locs = HvWhereCanTheyGo(hv, PLAYER_DRACULA,
		                                        &numLocs);
	...
	{///////////////////////////////////////////////////////////////////
		...
		printf("Testing where can I go "
		       "(DR SEWARD, Round 1)\n");
		
		char *trail = "GPA.... SPA.... HVI.... MGE.... DCD.V.. "
					  "GNA.... ";
		Message messages[2] = {};
		HunterView hv = HvNew(trail, messages);
		printf("%d\n", HvGetPlayer(hv));
	...
	{///////////////////////////////////////////////////////////////////
		...
		printf("Testing where can I go by type"
		       "(DR SEWARD, Round 1)\n");
	...
	{///////////////////////////////////////////////////////////////////
		...
		printf("Testing where can I go by railway"
		       "(DR SEWARD, Round 1)\n");
	...
	{///////////////////////////////////////////////////////////////////
		...
		printf("Testing where can I go by road "
		       "(DR SEWARD, Round 1)\n");
	...
	{///////////////////////////////////////////////////////////////////
		...
		printf("Testing where can I go by boat"
		       "(DR SEWARD, Round 1)\n");
		
		char *trail = "GPA.... SBA.... HVI.... MGE.... DCD.V.. "
					  "GNA.... ";
		Message messages[2] = {};
		HunterView hv = HvNew(trail, messages);
		printf("%d\n", HvGetPlayer(hv));
