...
int main(void)
{
	...
	{///////////////////////////////////////////////////////////////////
		...
		int numTraps = -1;
		PlaceId *traps = DvGetTrapLocations(dv, &numTraps);
		for (int i = 0; i < numTraps; i++) {printf("    trap @ %-15s\n", placeIdToName(traps[i]));}
	...
	{///////////////////////////////////////////////////////////////////
		...
		printf("num_moves = %d\n", numMoves);
		for (int i = 0; i < numMoves; i++) printf("    moves @ %-15s\n", placeIdToName(moves[i]));
		assert(numMoves == 4);
	...
	{///////////////////////////////////////////////////////////////////
		...
		char *trail =
			"GGE.... SGE.... HGE.... MGE.... DKL.V.. "// klausenbury
			"GGE.... SGE.... HGE.... MGE.... DD1T... " // double1
			"GGE.... SGE.... HGE.... MGE.... DBCT... " // bucharest
		...
		int numMoves = -1;
		PlaceId *moves = DvGetValidMoves(dv, &numMoves);
		for (int i = 0; i < numMoves; i++) printf("    locs  @ %-15s\n", placeIdToName(moves[i])); 
